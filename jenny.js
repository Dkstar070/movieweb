...
function takeCommand(message) {
    ...
    if (message.includes('hey') || message.includes('hello') || message.includes('hi')) {
        ...
        openMovie('Jurassic.World.Dominion.2022..Extended.Cut.Bluray.720p.Hindi.English.Esubs.Vegamovies.NL.mkv');
        speak("okey")
    }
    else if (message.includes("john wick") || message.includes("JHON WICK")) {
        openMovie('john wick.webm');
        speak("okey")
    }
